...
GO
PRINT N'Création de Contrainte de validation [dbo].[CK_Student_YearResult0]...';


GO
ALTER TABLE [dbo].[Student]
    ADD CONSTRAINT [CK_Student_YearResult0] CHECK (YearResult >= 0);


GO
PRINT N'Création de Contrainte de validation [dbo].[CK_Student_YearResult20]...';


GO
ALTER TABLE [dbo].[Student]
    ADD CONSTRAINT [CK_Student_YearResult20] CHECK (YearResult <= 20);
...
GO
ALTER TABLE [dbo].[Student]
    ADD CONSTRAINT [CK_Student_BirthDate] CHECK (BirthDate >= '1930-01-01 00:00:00');
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0809435f-d46e-4fe7-9e04-5decfaeb4d6d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0809435f-d46e-4fe7-9e04-5decfaeb4d6d')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'efcda2d2-a983-489b-898a-d44c469be268')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('efcda2d2-a983-489b-898a-d44c469be268')
...
INSERT INTO section VALUES (1020, 'Comptabilite');
INSERT INTO section VALUES (1110, 'Tourisme');
INSERT INTO section VALUES (1120, 'Dessin 3D');
INSERT INTO section VALUES (1310, 'Administrateurs Systeme');
INSERT INTO section VALUES (1320, 'Secretariat');
