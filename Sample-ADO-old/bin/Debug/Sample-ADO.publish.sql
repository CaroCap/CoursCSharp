/*
Script de déploiement pour Film-Actor
...
GO
:setvar DatabaseName "Film-Actor"
:setvar DefaultFilePrefix "Film-Actor"
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Actor]...';


GO
ALTER TABLE [dbo].[Film]
    ADD CONSTRAINT [FK_Actor] FOREIGN KEY ([idActor]) REFERENCES [dbo].[Actor] ([Id]);
